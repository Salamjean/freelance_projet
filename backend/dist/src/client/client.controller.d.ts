...
export declare class ClientController {
    ...
    getDashboard(clientId: number): Promise<{
        projects: ({
            applications: ({
                freelancer: {
                    profile: {
    ...
    createProject(clientId: number, createProjectDto: CreateProjectDto): Promise<{
        id: number;
        createdAt: Date;
        updatedAt: Date;
        title: string;
    ...
    updateProject(projectId: number, createProjectDto: CreateProjectDto): Promise<{
        id: number;
        createdAt: Date;
        updatedAt: Date;
        title: string;
    ...
    validateDelivery(clientId: number, contractId: number, body: {
